(function ($) {
 "use strict";
			...
			$('#basicDefaultImage').on('click', function () {
                Lobibox.notify('default', {
                    img: 'images/admin_images/notification/1.jpg',
                    msg: 'Lorem ipsum dolor sit amet against apennine any created, spend loveliest, building stripes.'
                });
            });
            ...
            $('#basicWarningImage').on('click', function () {
                Lobibox.notify('warning', {
                    img: 'images/admin_images/notification/2.jpg',
                    msg: 'Lorem ipsum dolor sit amet against apennine any created, spend loveliest, building stripes.'
                });
            });
            $('#basicErrorImage').on('click', function () {
                Lobibox.notify('error', {
                    img: 'images/admin_images/notification/3.jpg',
                    msg: 'Lorem ipsum dolor sit amet against apennine any created, spend loveliest, building stripes.'
                });
            });
            $('#basicSuccessImage').on('click', function () {
                Lobibox.notify('success', {
                    img: 'images/admin_images/notification/4.jpg',
                    msg: 'Lorem ipsum dolor sit amet against apennine any created, spend loveliest, building stripes.'
                });
            });
