  ...
  <div class="row">
    ...
    {{-- <div class="text-center mt-4">
      ...
      <div class="panel-body">
        <form id="validation-form" method="post" action="{{ route('ho-nurses.update', $nurse->id) }}" enctype="multipart/form-data" >
          {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="form-group col-lg-10" style=" margin-left: 20px;">
              ...
              <input type="email" class="form-control" name="email" id="email" value="{{ $nurse->email }}" disabled required>
            </div>
             <div class="form-group col-lg-5" style=" margin-left: 20px;">
              <label class="form-label">Birthdate</label>
              <input type="date" class="form-control" name="birthdate" id="birthdate" value="{{ $nurse->birthdate }}" disabled required>
            </div>
             ...
             <div class="form-group col-lg-10" style=" margin-left: 20px;">
              ...
              <textarea class="form-control" name="address" required id="address">{{ $nurse->address }}</textarea>
            </div>
             <div class="form-group col-lg-5" style=" margin-left: 20px;">
             ...
             <div class="form-group col-lg-5" style=" margin-left: 20px;">
              ...
              <input type="text" class="form-control" name="experience" id="experince" value="{{ $nurse->experience }}" disabled required>
            </div>
             <div class="form-group col-lg-5" >
              <label class="form-label">Mobile</label>
              <input type="text" class="form-control" name="mobile" id="mobile" value="{{ $nurse->mobile }}" required>
            </div>
             <div class="form-group col-lg-5" style=" margin-left: 20px;">
              <label class="form-label">Marital Status</label><br>
              @if ($nurse->marital_status == 1)
