    ...
    <div class="content-error">
      ...
      <h1 class="h2">ADD NURSES </h1>
        ...
        <div class="panel-body">
          <form id="validation-form" method="post" action="{{ route('ho-nurses.store') }}" enctype="multipart/form-data" >
            {{ csrf_field() }}
          ...
          <div class="form-group col-lg-5" >
           ...
           <div class="form-group col-lg-5" >
             ...
             <input type="text" class="form-control" name="mobile" id="mobile" pattern="[6789][0-9]{9}" required>
           </div>
           <div class="form-group col-lg-5" style=" margin-left: 20px;">
