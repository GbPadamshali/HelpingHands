        ...
        <div class="sticky-header  main-bar-wraper navbar-expand-lg">
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    <!-- website logo -->
                    <div class="logo-header mostion"><a href="index-2.html"><img src="{{ asset('images/user_images/logo.png') }}" alt="" style="height: 100px; width: 100px;"></a></div>
                    <!-- nav toggle button -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        <ul class=" nav navbar-nav">
                                <li> <a href="{{ url('dashboard') }}">Home<i class="fa fa-chevron-down"></i></a>
                                    {{-- <ul class="sub-menu">
                                ...
                                <li> <a href="{{ url('contact-us') }}">Contact us<i class="fa fa-chevron-down"></i></a>
                                    {{-- <ul class="sub-menu">
