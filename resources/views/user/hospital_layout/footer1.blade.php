            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                    <div class="widget widget_about">
                        <div class="logo-footer"><img src="{{ asset($data->logo_path) }}" alt="{{ $data->name }}"></div>
                        <p class="m-t40"><strong>{{ $data->name }}</strong>
                          {{ $data->description }}</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                    <div class="widget widget_getintuch">
                        ...
                        <div class="dez-separator bg-primary"></div>
                        <ul>
                            <li><i class="fa fa-map-marker"></i><strong>Address</strong> {{ $data->address }} </li>
                            <li><i class="fa fa-phone"></i><strong>phone</strong>{{ $data->contact_no }}</li>
                            <li><i class="fa fa-envelope"></i><strong>Email</strong>{{ $data->email }}<br/>
                          </li>
                        </ul>
                    </div>
                </div>
