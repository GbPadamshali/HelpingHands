        ...
        <div class="sticky-header  main-bar-wraper navbar-expand-lg">
            <div class="main-bar clearfix ">
                <div class="container clearfix">
                    <!-- website logo -->
                    <div class="logo-header mostion"><a href="{{ url('hospital/'.$data->id) }}"><img src="{{ asset($data->logo_path) }}" style="height: 80px; width: 100px;" alt=""></a></div>
                    <!-- nav toggle button -->
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        <ul class=" nav navbar-nav">
                                <li> <a href="{{ url($data->name) }}">Home<i class="fa fa-chevron-down"></i></a>
                                    {{-- <ul class="sub-menu">
                                ...
                                <li> <a href="{{ url('booking') }}">Booking<i class="fa fa-chevron-down"></i></a>
                                </li>
                                <li> <a href="{{ url('/booking') }}">Contact us <i class="fa fa-chevron-down"></i></a>
                                    {{-- <ul class="sub-menu">
